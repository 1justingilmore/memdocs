...
> [!Important]  
> Windows 10 and Windows Server 2016 have Microsoft Defender installed by default. You don't need this procedure on those versions of Windows.  
...
- If you want to install the Endpoint Protection client with the latest definitions, download them from [Microsoft Defender Security Intelligence](https://www.microsoft.com/wdsi).  
