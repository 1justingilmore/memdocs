...
- **Antivirus**:  
  ...
  > [!NOTE]
  > The DeviceStatus CSP for Antivirus isn’t supported for *Windows 10 Home* and reports a status of *Not applicable*. The Intune team is working on a fix. To work around this limitation, consider using [Microsoft Defender](#defender) settings in your device compliance policy. Microsoft Defender settings are supported with Windows 10 Home.  
