...
- **Microsoft Defender Firewall** – Configure settings for Microsoft Defender Firewall with Advanced Security. Microsoft Defender Firewall provides host-based, two-way network traffic filtering for a device and can block unauthorized network traffic flowing into or out of the local device.
